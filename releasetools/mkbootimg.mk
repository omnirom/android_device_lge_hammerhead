...
## values.
HAM_DTS_TARGET ?= msm8974-hammerhead
...
HAM_DTS_NAMES := msm8974

HAM_DTS_FILES = $(wildcard $(TOP)/$(TARGET_KERNEL_SOURCE)/arch/arm/boot/dts/$(HAM_DTS_TARGET)*.dts)
HAM_DTS_FILE = $(lastword $(subst /, ,$(1)))
DTB_FILE = $(addprefix $(KERNEL_OUT)/arch/arm/boot/,$(patsubst %.dts,%.dtb,$(call HAM_DTS_FILE,$(1))))
ZIMG_FILE = $(addprefix $(KERNEL_OUT)/arch/arm/boot/,$(patsubst %.dts,%-zImage,$(call HAM_DTS_FILE,$(1))))
KERNEL_ZIMG = $(KERNEL_OUT)/arch/arm/boot/zImage
DTC = $(KERNEL_OUT)/scripts/dtc/dtc

define append-ham-dtb
mkdir -p $(KERNEL_OUT)/arch/arm/boot;\
$(foreach HAM_DTS_NAME, $(HAM_DTS_NAMES), \
   $(foreach d, $(HAM_DTS_FILES), \
